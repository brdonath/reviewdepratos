...
angular.module('google.places', [])
	...
	.directive('gPlacesAutocomplete',
        [ '$parse', '$compile', '$timeout', '$document', 'googlePlacesApi', '$cordovaGeolocation',
        function ($parse, $compile, $timeout, $document, google, $cordovaGeolocation) {
            ...
            return {
                ...
                link: function ($scope, element, attrs, controller) {
                    ...
                    (function init() {
                        ...
                        initGeoLocation();
                        if( $scope.control ){
                            $scope.control.clearPredictions = clearPredictions;
                        }
                    }());
                    ...
                    function initGeoLocation() {
                        $cordovaGeolocation.getCurrentPosition({ timeout: 10000, enableHighAccuracy: false })
                            .then(function (position) {
                                ...
                                $scope.options.bounds = circle.getBounds();
                            }, function (err) {
                                console.log(err);
                            });
                    }
